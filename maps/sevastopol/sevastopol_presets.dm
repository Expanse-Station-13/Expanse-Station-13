...
// Substation SMES
/obj/machinery/power/smes/buildable/preset/sevastopol/substation/configure_and_install_coils()
...
/obj/machinery/power/smes/buildable/preset/sevastopol/substation_full/configure_and_install_coils()
	component_parts += new /obj/item/weapon/smes_coil(src)
	component_parts += new /obj/item/weapon/smes_coil(src)
	_input_maxed = TRUE
	_output_maxed = TRUE
...
/obj/machinery/power/smes/buildable/preset/sevastopol/engine_main/configure_and_install_coils()
...
// Shuttle SMES
/obj/machinery/power/smes/buildable/preset/sevastopol/shuttle/configure_and_install_coils()
	component_parts += new /obj/item/weapon/smes_coil/super_io(src)
	_input_maxed = TRUE
	_output_maxed = TRUE
	_input_on = TRUE
